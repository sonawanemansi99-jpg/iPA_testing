...
import 'package:corporator_app/admin_group/admin_group_list_page.dart';
import 'package:corporator_app/core/constants/constants.dart';
...
import 'package:corporator_app/superadmin/global_complaints_page.dart';
import 'package:corporator_app/superadmin/global_zone_list_page.dart';
import 'package:corporator_app/superadmin/global_zone_sevak_page.dart';
import 'package:corporator_app/superadmin/super_admin_list_page.dart';
...
class _SuperAdminDashboardState extends State<SuperAdminDashboard>
  ...
  Future<void> _fetchGlobalStats() async {
    ...
    try {
      ...
      if (zoneRes.statusCode == 200)
        totalZones = (jsonDecode(zoneRes.body)['data'] as List).length;
      ...
      if (compRes.statusCode == 200)
        totalComplaints = (jsonDecode(compRes.body)['data'] as List).length;
      ...
      if (adminRes.statusCode == 200)
        totalAdmins = (jsonDecode(adminRes.body)['data'] as List).length;
    } catch (e) {
      if (mounted)
        CustomSnackBar.showError(context, "Failed to sync stats: $e");
    } finally {
      if (mounted) setState(() => _isLoading = false);
    }
  }
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildActionButton(
                                  ...
                                  hindi: "संगठनात्मक समूह",
                                  english: "ADMIN GROUPS",
                                  color: const Color(
                                    0xFF007A33,
                                  ), // A nice teal color
                                  accentColor: Colors.white,
