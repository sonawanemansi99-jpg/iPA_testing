...
class _EditComplaintStatusState extends State<EditComplaintStatus> {
  ...
  Future<void> updateComplaint() async {
    ...
    try {
      ...
      // STEP 1: Find document by complaintId
      ...
      if (selectedStatus == "complete") {
        historyItem["actionTaken"] = actionDescriptionController.text;
      }
  ...
  //     /// STEP 2: Get Firestore document reference
  ...
  //     /// STEP 4: Update status and append history
  //     await docRef.update({
  //       "status": selectedStatus,
