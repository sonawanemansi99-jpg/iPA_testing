                      ...
                      children: [
                        _buildSectionCard(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            _buildField(controller: mobileController, label: "Mobile Number", hint: "Enter 10-digit mobile number", icon: Icons.phone_outlined, keyboardType: TextInputType.phone),
                            const SizedBox(height: 16),
                            _buildField(controller: adharController, label: "Aadhar Number", hint: "Enter 12-digit Aadhar number", icon: Icons.credit_card_outlined, keyboardType: TextInputType.number),
                            const SizedBox(height: 16),
